...
class ExceptionsPage(BasePage):
    ...
    __add_button_locator = (By.XPATH, "//button[@id='add_btn']")
    __row_1_edit_button = (By.XPATH, "//button[@id='edit_btn']")
    __row_1_input_element = (By.XPATH, "//div[@id='row1']/input[@class='input-field']")
    __row_1_save_button = (By.XPATH, "//div[@id='row1']/button[@name='Save']")
    __row_2_input_element = (By.XPATH, "//div[@id='row2']/input[@type='text']")
    __row_2_save_button = (By.XPATH, "//div[@id='row2']/button[@name='Save']")
    __confirmation_message = (By.XPATH, "//div[@id='confirmation']")
    __instructions_element = (By.XPATH, "//p[@id='instructions']")
    ...
    def add_second_food(self, food: str):
        ...
        super()._wait_until_element_is_visible(self.__confirmation_message)

    def get_confirmation_message(self) -> str:
        return super()._get_text(self.__confirmation_message, time=3)
